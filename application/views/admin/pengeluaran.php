      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <h3>Cetak Pengeluaran Data</h3>
             <form role="form" method="post" action="<?php echo base_url()?>index.php/admin/cetak_pengeluaran">
                    <div class="form-group">
                      <label for="tanggal">Cetak Mulai Tanggal</label>
                      <input type="date" name="tanggalmulai" class="form-control" id="tanggal">
                    </div>
                    <div class="form-group">
                      <label for="tanggal">Cetak Sampai Tanggal</label>
                      <input type="date" name="tanggalsampai" class="form-control" id="tanggal">
                    </div>
            ...
            <?php
                foreach($pengeluaran as $t_pengeluaran){
                    //$auth = base64_encode(md5($user->keyword));
        ?>
                                    ...
                                    <tbody>
                                        <tr class="gradeA">
                                            <td><?php echo $t_pengeluaran->nomor; ?></td>
                                            <td><?php echo $t_pengeluaran->tanggal; ?></td>
                                            <td>Rp. <?php echo $t_pengeluaran->jumlah; ?></td>
                                            <td><?php echo $t_pengeluaran->keterangan; ?></td>
                                            <td><a href="?kode=<?php echo $t_pengeluaran->nomor; ?>#popup"><button class="btn btn-primary btn-flat">Lihat</button></a></td>
                                            <?php } ?>
                                        </tr>
                            ...
                            <a href="<?php echo base_url()?>index.php/admin/tambah_pengeluaran"><button class="btn btn-primary btn-flat">Tambah Data pengeluaran</button></a>
                </div>
              </div><!-- /.nav-tabs-custom -->
            </section><!-- /.Left col -->
...
<div id="popup">
    ...
    <div class="box box-widget widget-user-2">
                ...
                <div class="widget-user-header bg-aqua-active">
                  <h3 class="widget-user-username">PT Lampung Jaya Abadi</h3>
                  <h5 class="widget-user-desc">Data pengeluaran</h5>
                </div>
           ...
           <?php
                foreach($lihatpengeluaran as $t_lihatpengeluaran){
        ...
        ?>      
                                    ...
                                    <tbody>
                                        <tr class="gradeA">
                                            <td><?php echo $t_lihatpengeluaran->nomor; ?></td>
                                            <td><?php echo $t_lihatpengeluaran->tanggal; ?></td>
                                            <td>Rp. <?php echo $t_lihatpengeluaran->jumlah; ?></td>
                                            <td><?php echo $t_lihatpengeluaran->keterangan; ?></td>
                                            <?php } ?>
                                        </tr>
                            ...
                            <a href="<?php echo base_url()?>index.php/admin/edit_pengeluaran?kode=<?php echo $t_lihatpengeluaran->nomor; ?>"><button class="btn btn-primary btn-flat">Edit</button></a>
                            <a href="<?php echo base_url()?>index.php/admin/pengeluaran/delete?kode=<?php echo $t_lihatpengeluaran->nomor; ?>"><button class="btn btn-danger btn-flat">Hapus</button></a>
