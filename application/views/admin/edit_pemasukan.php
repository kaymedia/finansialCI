      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <?php
                foreach($editpemasukan as $t_editpemasukan){
                    
        ?>
                                   <div class="box-body">
                 <form role="form" method="post" action="<?php echo base_url()?>index.php/admin/edit_pemasukan/simpan">
                  <div class="box-body">
                    <div class="form-group">
                    <input type="hidden" name="nomor" class="form-control" id="nomor" value="<?php echo $t_editpemasukan->nomor; ?>">
                      <label for="tanggal">Tanggal</label>
                      <input type="date" name="tanggal" class="form-control" id="tanggal" value="<?php echo $t_editpemasukan->tanggal; ?>">
                    </div>
                    <div class="form-group">
                      <label for="jumlah">Jumlah</label>
                     Rp. <input type="text" class="form-control" id="jumlah" name="jumlah" value="<?php echo $t_editpemasukan->jumlah; ?>">
                    </div>
                    <div class="form-group">
                      <label for="keterangan">Keterangan</label>
                      <textarea class="form-control" id="keterangan" name="keterangan"><?php echo $t_editpemasukan->keterangan; ?></textarea>
                    </div>
                  </div><!-- /.box-body -->
