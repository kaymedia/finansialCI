...
<html>
  <head>
    ...
    <title>PT Lampung Jaya Abadi | Dashboard</title>
...
$(document).ready(function() {
      ...
      chart1 = new Highcharts.Chart({
         ...
         title: {
            ...
            text: 'Statistik Pengeluaran dan Pemasukan PT Lampung Jaya Abadi '

         },

         xAxis: {

            categories: ['Pengeluaran dan Pemasukan Selama Bulan ini']
         ...
         yAxis: {
            ...
            [
                     ...
                     <?php
                      ...
                      data: [<?php echo $pengeluaranbulan;  ?>]
...
<!-- CHART DUA TOTAL PENGELUARAN DAN PPEMASUKAN -->
 <script type="text/javascript">
...
$(document).ready(function() {
      ...
      chart1 = new Highcharts.Chart({
         ...
         title: {
            ...
            text: 'PT Lampung Jaya Abadi '

         },

         xAxis: {

            categories: ['Total Pengeluaran dan Pemasukan']
         ...
         yAxis: {
            ...
            [
                      ...
                      $jalan = mysql_query($query);
                      $datamasuk = mysql_fetch_array($jalan);
                      $pemasukan = $datamasuk['totalmasuk'];?>
                      ...
                      $jalan = mysql_query($query);
                      $datamasuk = mysql_fetch_array($jalan);
                      $pengeluaran = $datamasuk['totalkeluar'];?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <section class="col-lg-8 connectedSortable">
              ...
              <div class="box box-success">
                <div class="box-header">
                  <h3 class="box-title">5 Data Pemasukan Terakhir</h3>
                </div>
            ...
            <?php
                foreach($pemasukanindex as $t_pemasukanindex){
        ...
        ?>
                                    ...
                                    <tbody>
                                        <tr class="gradeA">
                                            <td><?php echo $t_pemasukanindex->nomor; ?></td>
                                            <td><?php echo $t_pemasukanindex->tanggal; ?></td>
                                            <td>Rp. <?php echo $t_pemasukanindex->jumlah; ?></td>
                                            <td><?php echo $t_pemasukanindex->keterangan; ?></td>
                                            <?php } ?>
                                        </tr>
           ...
           <!-- Chat box -->
              <div class="box box-success">
                <div class="box-header">
                  <h3 class="box-title">5 Data Pengeluaran Terakhir</h3>
                </div>
                <div class="box-body chat" id="chat-box">
                 <div class="table-responsive">
                    <table class="table no-margin">
            ...
            <?php
                foreach($pengeluaranindex as $t_pengeluaranindex){
                    //$auth = base64_encode(md5($user->keyword));
        ?>
                                    ...
                                    <tbody>
                                        <tr class="gradeA">
                                            <td><?php echo $t_pengeluaranindex->nomor; ?></td>
                                            <td><?php echo $t_pengeluaranindex->tanggal; ?></td>
                                            <td>Rp. <?php echo $t_pengeluaranindex->jumlah; ?></td>
                                            <td><?php echo $t_pengeluaranindex->keterangan; ?></td>
                                            <?php } ?>
                                        </tr>
