...
<a href="<?php echo base_url("index.php/admin/cetak_pengeluaran/cetak?tanggalmulai=$tanggalmulai&tanggalsampai=$tanggalsampai"); ?>">Cetak Data</a><br><br>
...
<?php
    foreach($cetak_pengeluaran as $cetak){
        echo "<tr>";
