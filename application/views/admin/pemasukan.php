...
<html>
  <head>
    ...
    <title>PT Lampung Jaya Abadi | Pemasukan</title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <h3>Cetak Pemasukan Data</h3>
             <form role="form" method="post" action="<?php echo base_url()?>index.php/admin/cetak_pemasukan">
            ...
            <?php
                foreach($pemasukan as $t_pemasukan){
        ...
        ?>
                                    ...
                                    <tbody>
                                        <tr class="gradeA">
                                            <td><?php echo $t_pemasukan->nomor; ?></td>
                                            <td><?php echo $t_pemasukan->tanggal; ?></td>
                                            <td>Rp. <?php echo $t_pemasukan->jumlah; ?></td>
                                            <td><?php echo $t_pemasukan->keterangan; ?></td>
                                            <td><a href="?kode=<?php echo $t_pemasukan->nomor; ?>#popup"><button class="btn btn-primary btn-flat">Lihat</button></a></td>
                                            <?php } ?>
                                        </tr>
                            ...
                            <a href="<?php echo base_url()?>index.php/admin/tambah_pemasukan"><button class="btn btn-primary btn-flat">Tambah Data Pemasukan</button></a>
                </div>
              </div><!-- /.nav-tabs-custom -->
            </section><!-- /.Left col -->
...
<div id="popup">
    ...
    <div class="box box-widget widget-user-2">
                ...
                <div class="widget-user-header bg-aqua-active">
                  ...
                  <h5 class="widget-user-desc">Data Pemasukan</h5>
                </div>
           ...
           <?php
                foreach($lihatpemasukan as $t_lihatpemasukan){
        ...
        ?>      
                                    ...
                                    <tbody>
                                        <tr class="gradeA">
                                            <td><?php echo $t_lihatpemasukan->nomor; ?></td>
                                            <td><?php echo $t_lihatpemasukan->tanggal; ?></td>
                                            <td>Rp. <?php echo $t_lihatpemasukan->jumlah; ?></td>
                                            <td><?php echo $t_lihatpemasukan->keterangan; ?></td>
                                            <?php } ?>
                                        </tr>
                            ...
                            <a href="<?php echo base_url()?>index.php/admin/edit_pemasukan?kode=<?php echo $t_lihatpemasukan->nomor; ?>"><button class="btn btn-primary btn-flat">Edit</button></a>
                            <a href="<?php echo base_url()?>index.php/admin/pemasukan/delete?kode=<?php echo $t_lihatpemasukan->nomor; ?>"><button class="btn btn-danger btn-flat">Hapus</button></a>
