            ...
            <section class="col-lg-8 connectedSortable">
              ...
              <div class="nav-tabs-custom">
                ...
                <div class="tab-content no-padding">
                                   <div class="box-body">
                 <form role="form" method="post" action="<?php echo base_url()?>index.php/admin/tambah_pemasukan/tambah">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      Rp.<input type="jumlah" class="form-control" id="jumlah" name="jumlah">
                    </div>
                    <div class="form-group">
