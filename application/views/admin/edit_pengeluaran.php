      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <?php
                foreach($editpengeluaran as $t_editpengeluaran){
                    
        ?>
                                   <div class="box-body">
                 <form role="form" method="post" action="<?php echo base_url()?>index.php/admin/edit_pengeluaran/simpan">
                  <div class="box-body">
                    <div class="form-group">
                    <input type="hidden" name="nomor" class="form-control" id="nomor" value="<?php echo $t_editpengeluaran->nomor; ?>">
                      <label for="tanggal">Tanggal</label>
                      <input type="date" name="tanggal" class="form-control" id="tanggal" value="<?php echo $t_editpengeluaran->tanggal; ?>">
                    </div>
                    <div class="form-group">
                      <label for="jumlah">Jumlah</label>
                     Rp. <input type="text" class="form-control" id="jumlah" name="jumlah" value="<?php echo $t_editpengeluaran->jumlah; ?>">
                    </div>
                    <div class="form-group">
                      <label for="keterangan">Keterangan</label>
                      <textarea class="form-control" id="keterangan" name="keterangan"><?php echo $t_editpengeluaran->keterangan; ?></textarea>
                    </div>
                  </div><!-- /.box-body -->
